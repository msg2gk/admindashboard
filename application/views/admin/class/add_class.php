                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" action='<?php echo base_url();?>index.php/Classes/saveclass' method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Class Name</label>
                                            <input type="text" name="classname" class="form-control" id="" placeholder="Enter Class Name">
                                        </div>
