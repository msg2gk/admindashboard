                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" action='<?php echo base_url(); ?>index.php/Subjects/savesubjects' method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required="" name="class_name">
                                                ...
                                                <?php if (!empty($classlist)) {
                                                    foreach ($classlist as $v_class_list) {
                                                        ?>
                                                        <option value="<?php echo $v_class_list->class_id; ?>"><?php echo $v_class_list->class_name; ?></option>
                                                    <?php
                                                    }
                                                }
                                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subject_name" required="" class="form-control" id="" placeholder="Enter Class Name">
                                        </div>
