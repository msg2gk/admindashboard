                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" action='<?php echo base_url(); ?>index.php/Students/savestudent' method="POST">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="student_name" required="" class="form-control" id="" placeholder="Student Name">
                                        </div>
